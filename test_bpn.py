...
def load_model(model_path, device):
    ...
    model = BiPriorNet(n_channels=3, n_classes=1, img_size=512, backbone = "resnet50").to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default=r'checkpoints/unet_powerline_ep_3_0.0002.pth')
